...
public class Graph implements Iterable<Graph.Vertex> {
    ...
    /**
     * Nested class that represents an edge of a aps180006.Graph
     */
	...
	*/
    ...
    /**
     * Constructor for aps180006.Graph
     * 
     * @param n
	...
	System.out.println("aps180006.Graph: n: " + size() + ", m: " + edgeSize() + ", directed: " + directed + ", Edge weights: " + hasEdgeWeights);
	for(Vertex u: this) {
	    System.out.print(u + " : ");
    ...
    // Utilities of aps180006.Graph class:
    /**
     * Find vertex no. n
     * @param n
     *           : int
